...
export const HeroParallax = ({
	...
	return (
		<div
			ref={ref}
			className="h-full py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] bg-[#0A0A0A] text-white"
		>
			<Header />
			<motion.div
				style={{
		...
		<div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0 sm:-top-20">
			<div className="max-w-7xl absolute z-10 mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0 sm:-top-20">
				<h1 className="text-2xl md:text-6xl font-bold sm:w-[60%] dark:text-white">
					...
					<span className="text-blue-500"> CRYPTO & BLOCKCHAIN</span>
				</h1>
				{/* Space between twop thing */}
				<p className="max-w-2xl text-base md:text-xl mt-7 dark:text-neutral-200 mb-8">
